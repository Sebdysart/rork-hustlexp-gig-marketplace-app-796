      ...
      addAIMessage("What kind of work can you do?", 'skills', [
        {
          ...
          data: {
            categories: [
              ...
              { id: 'pet_care', label: '🐕 Pet Care', popular: true },
              { id: 'tutoring', label: '📚 Tutoring', popular: false },
              { id: 'home_repair', label: '🔧 Handy', popular: false },
              { id: 'lawn_care', label: '🌱 Lawn Care', popular: true },
              { id: 'babysitting', label: '👶 Babysitting', popular: false },
              { id: 'grocery_shopping', label: '🛒 Shopping', popular: true },
              { id: 'furniture_assembly', label: '🪛 Assembly', popular: false },
              { id: 'car_wash', label: '🚗 Car Wash', popular: false },
              { id: 'event_help', label: '🎉 Event Help', popular: false },
              { id: 'packing', label: '📦 Packing', popular: false },
              { id: 'organizing', label: '📋 Organizing', popular: false },
              { id: 'tech_support', label: '💻 Tech Support', popular: false },
              { id: 'meal_prep', label: '🍳 Meal Prep', popular: false },
              { id: 'laundry', label: '🧺 Laundry', popular: false },
              { id: 'photography', label: '📸 Photography', popular: false },
              { id: 'graphic_design', label: '🎨 Design', popular: false },
              { id: 'video_editing', label: '🎬 Video Edit', popular: false },
              { id: 'music_lessons', label: '🎸 Music', popular: false },
              { id: 'fitness_training', label: '💪 Training', popular: false },
              { id: 'massage', label: '💆 Massage', popular: false },
              { id: 'hair_styling', label: '💇 Hair', popular: false },
              { id: 'makeup', label: '💄 Makeup', popular: false },
              { id: 'tailoring', label: '🪡 Tailoring', popular: false },
            ],
            trades: [
              ...
              { id: 'tile_setter', label: '🟦 Tile Setter' },
              { id: 'auto_mechanic', label: '🔧 Mechanic' },
              { id: 'locksmith', label: '🔐 Locksmith' },
              { id: 'pest_control', label: '🐛 Pest Control' },
              { id: 'pool_maintenance', label: '🏊 Pool Tech' },
            ],
          },
        },
      ]);
