...
export default function WelcomeTutorialScreen() {
  ...
  const tutorialKeys = [
    'Welcome, Business Commander! 💼',
    "You're now in Business Mode. Post tasks, hire workers, and grow your empire.",
    'AI-Powered Task Creation',
    'Use our AI Assistant to create tasks instantly. Just tell us what you need, and we match you with the perfect worker.',
    'Try AI Creator',
    'Instant Matching',
    'Our AI finds qualified workers near you based on skills, ratings, and availability. Get matched in seconds!',
    'Track & Protect',
    'Monitor progress with GPS check-ins, proof photos, and real-time updates. Escrow protects both parties.',
    'Build Your Reputation',
    'Rate workers after completion. Great reviews attract top talent and help the community thrive.',
    'Welcome, Tradesman Pro! 🔧',
    "You're in Tradesmen Mode. Accept pro jobs, earn trade badges, and build your career.",
    'Trade Badge System',
    'Earn specialized badges from Copper to Diamond as you master your craft. Each level unlocks higher-paying jobs.',
    'Premium Earnings',
    'Skilled trade jobs pay more. Build your reputation to unlock exclusive high-value projects.',
    'Form Squads',
    ...
    'Find Tasks Nearby',
    'Browse the map to discover gigs in your area. Filter by pay, distance, and category.',
    'Open Map',
    'Accept & Complete Tasks',
    'Choose tasks that match your skills. Submit proof when done, and get paid instantly.',
    'Build Your Profile',
    'Complete tasks to boost your trust score. Better reputation means more opportunities and higher pay.',
    'Stay Protected',
    'Escrow system holds payment safely. Only released when both parties confirm completion.',
    'Chat with HustleAI',
    'Get personalized guidance, task suggestions, and instant help from our AI assistant. Available 24/7 in your chat.',
    'Skip',
    'Next',
    "Let's Hustle! 🚀",
    'of',
  ];
  const translations = useTranslatedTexts(tutorialKeys);
        ...
        <View style={styles.header}>
          <View style={styles.progressContainer}>
            ...
            <Text style={styles.progressText}>
              {currentSlide + 1} {translations[38]} {slides.length}
            </Text>
          </View>
          
          <TouchableOpacity style={styles.skipButton} onPress={handleSkip}>
            <Text style={styles.skipText}>{translations[35]}</Text>
          </TouchableOpacity>
        </View>
          ...
          >
            ...
            >
              <Text style={styles.nextButtonText}>
                {currentSlide === slides.length - 1 ? translations[37] : translations[36]}
              </Text>
